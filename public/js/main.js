(function () {
    ...
    function getContent(fragmentId, callback) {
        if (partialsCache[fragmentId]) {
            ...
            fetchFile("public/partials/" + fragmentId + ".html", function (content) {
                partialsCache[fragmentId] = content;
                callback(content);
            });
        }

        fetchFile("public/partials/" + fragmentId + ".html", callback);
    }

    function setActiveLink(fragmentId) {
        let links = document.querySelectorAll("ul#main-nav li a"),
